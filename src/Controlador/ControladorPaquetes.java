...
public class ControladorPaquetes {
     ...
     * @throws SQLException
     */
    public boolean agregarPaquetes(int idPaquete, int idProveedor, int idServicio) throws SQLException {
        return dao.insertarElemento(idPaquete, idProveedor, idServicio);
    }
